# Generated by Django 4.2.6 on 2025-02-24 17:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concentrado_equino.pedido')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to='concentrado_equino.pedido')),
            ],
        ),
        migrations.CreateModel(
            name='CarritoItem',
            fields=[
                ...
                ('carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concentrado_equino.carrito')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concentrado_equino.producto')),
            ],
        ),
        migrations.AddField(
            model_name='carrito',
            name='productos',
            field=models.ManyToManyField(through='concentrado_equino.CarritoItem', to='concentrado_equino.producto'),
        ),
        migrations.AddField(
            model_name='carrito',
            name='usuario',
